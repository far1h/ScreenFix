...
test "$(plutil -extract CFBundleShortVersionString raw "$INFO_PLIST")" = "1.0.4"
test "$(plutil -extract CFBundleVersion raw "$INFO_PLIST")" = "4"
...
test "$(plutil -extract CFBundleShortVersionString raw "$EXTRACTED_INFO_PLIST")" = "1.0.4"
test "$(plutil -extract CFBundleVersion raw "$EXTRACTED_INFO_PLIST")" = "4"
