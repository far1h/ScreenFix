...
test "$(plutil -extract CFBundleShortVersionString raw "$APP_PATH/Contents/Info.plist")" = "1.0.4"
test "$(plutil -extract CFBundleVersion raw "$APP_PATH/Contents/Info.plist")" = "4"
